...
# from .models import UserProfile, Product, Order, CartItem, FarmerProfile, BuyerProfile, Crop, CropPrice
# from django.conf import settings
# from django import forms
# from .forms import (
#     OrderForm, ProductSearchForm, UserRegistrationForm, FarmerProfileForm,
#     BuyerProfileForm, ContactForm, CropInputForm, YieldPredictionForm, ProductForm
# )
...
#     user = request.user
#     unit = request.POST.get("unit", product.unit)  # default to product's unit if not provided
...
#     return redirect(next_url if next_url else 'product_list')
...
#     for item in cart_items:
#         try:
#             qty_str = request.POST.get(f'quantity_{item.id}', '').strip()
#             qty = int(qty_str) if qty_str else 1
#             unit_str = request.POST.get(f'unit_{item.id}', '').strip()
#             item.quantity = qty
#             item.unit = unit_str or item.unit
#             item.save()
#         except (ValueError, TypeError):
#             continue

#     messages.success(request, "Cart updated successfully.")
#     return redirect('cart')  # view_cart's URL name
...
# # Yield Prediction
# yield_model_path = os.path.join(settings.BASE_DIR, 'ml_models', 'dtr.pkl')
...
#             return redirect('farmer_dashboard')  # or wherever you want
#     else:
#         form = ProductForm()
...
#     return render(request, 'direct-selling/product_list.html', {
#         'products': products,
#         'form': form
#     })
...
#     return render(request, 'direct-selling/product_detail.html', {
#         'product': product,
#         'images': images,
#         'reviews': reviews
#     })
